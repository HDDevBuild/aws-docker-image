...
# See instructions at https://learn.microsoft.com/en-us/powershell/scripting/install/install-other-linux?view=powershell-7.4#installation-using-a-binary-archive-filedocker build -t aws/codebuild/standard:6.0 .
...
#phpenv
RUN curl -L https://raw.githubusercontent.com/phpendocker build -t aws/codebuild/standard:6.0 .v/phpenv-installer/master/bin/phpenv-installer | bash
